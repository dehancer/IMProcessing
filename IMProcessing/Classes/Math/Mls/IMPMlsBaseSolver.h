...
namespace IMProcessing {
    ...
    public:
         ...
         */
        IMPMlsBaseSolver(const float2 point,
...
#endif
                         const int count,
                         const IMPMlsSolverKind kind = IMPMlsSolverKindAffine,
    ...
    private:
        ...
        void solveW() {
            ...
            for (int i=0; i<count_ && i<MLS_MAXIMUM_POINTS; i++) {
                ...
                float d =  pow(distance(p_[i], point_), alpha_);
        ...
        void solveHat(){
            ...
            for (int i=0; i<count_ && i<MLS_MAXIMUM_POINTS; i++) {
                ...
                switch (kind_) {
                    case IMPMlsSolverKindSimilarity:
                        mu_ += similarityMu(i);
                        break;
                    case IMPMlsSolverKindRigid:
                        _rmu1 += rigidMu1(i);
                        _rmu2 += rigidMu2(i);
                        break;
                    default:
